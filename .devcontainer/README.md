...
3. Once the container is running, the Omada controller becomes available on the forwarded ports and Yarn dependencies are installed automatically.
...
Use `yarn dev` inside the container to launch the MCP server in watch mode.
